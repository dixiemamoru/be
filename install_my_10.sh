...
swapEndpoint='wss://goerli.infura.io/ws/v3/fb705f6f9efb4305a032aa8860952432'
...
wget https://github.com/ethersphere/bee-clef/releases/download/v0.4.12/bee-clef_0.4.12_amd64.deb && dpkg -i bee-clef_0.4.12_amd64.deb
